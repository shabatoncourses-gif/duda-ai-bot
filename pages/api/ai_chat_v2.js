...
function detectInfoPages(question) {
  ...
  const pages = [
    ...
    { kw: ['חובות לימודים','שעות חובה','שעות השלמה','שעות רשות','ש"ש רשות','ש"ש חובה','רשות בשבתון','כמה רשות','לימודי חובה','לימודי השלמה','מוסדות מאושרים','נושאי השתלמות','ספורט בשבתון','שינוי תוכנית','תואר שלישי','דוקטורט','גמול השתלמות','מסלול אישי','פרויקט אישי','ישיבה','לימודים בחו"ל','לימודים בחול','תוכנית לימודים','תוכנית הלימודים','תכנית הלימודים','להרכיב תוכנית','הרכבת תוכנית','בניית תוכנית','מה ללמוד','כמה שעות','תכנית לימודים','לימוד בשבתון','לימודי רשות','לימודי חובה ורשות','מוסדות ללמוד','מוכר לשבתון','הכרה במוסד','האם מוכר','מוסד מוכר','קורס מוכר','מוכרת לשבתון','תוכנית הלימודים אושרה','תכנית הלימודים אושרה','אישור תוכנית הלימודים','אישור תכנית הלימודים','אישור הקרן','התוכנית אושרה','התכנית אושרה','אושרה על ידי הקרן','פורטל עובדי הוראה'], url: 'https://www.shabaton.online/learning_programs_shabaton' },
