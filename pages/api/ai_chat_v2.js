...
function stripNavDropdown(text) {
  ...
  // התגלו 3 variants של אותו widget: לפעמים עם רשימת-אזורים לפני רשימת-
  // התחומים, לפעמים בלי. לכן שני regex-ים נפרדים: אחד לרשימת-האזורים
  // (אופציונלי), ואחד ל"בחרו תחום לימודים" שמופיע תמיד בכל ה-variants
  // שנצפו עד כה, עד הפריט האחרון ברשימה ("תרפיה וטיפול") או עד סוף המחרוזת
  // (אם נחתך ע"י מגבלת-האורך).
