...
const SYSTEM_PROMPT =
  ...
  'פורמט לכל מוסד (context מכיל "שם:", "קישור:", "תיאור:"):\n' +
  '### [תוכן שם:](תוכן קישור:)\n' +
  'תוכן תיאור: — העתק בדיוק.\n' +
  '[פנו למידע ולייעוץ אישי](תוכן קישור:)\n\n' +

  '=== שאלות מידע ===\n' +
  'קח מידע אך ורק מה-context. תן תשובה מלאה וממצה — לא תקציר קצר. כלול סכומים, תנאים, מועדים וכל פרט חשוב. אל תכתוב "בדף תמצאו" — כתוב את המידע עצמו. הוסף [לפירוט ולמידע נוסף](URL).\n\n' +
