...
const SYSTEM_PROMPT =
  ...
  'לעולם אל תאמר שאין קורסים, שאתה מצטער, או שאינך יכול לענות.\n' +
  'כלל ברזל: אל תמציא מידע שאינו ב-context. אסור לציין "יועצי לימודים" או להפנות לגורמים שאינם בdף.\n' +
  ...
  'לכל מוסד:\n' +
  '**[שם המוסד](URL)** ← כותרת המוסד (Bold + קישור)\n' +
  'התיאור\n' +
  ...
  '2. הנקודות המרכזיות מהדף — בניסוח ברור ופשוט (לא העתקה מילולית, אלא תמצות).\n' +
  '3. פרטים חשובים: סכומים, מועדים, תנאים — רק מה שב-context.\n' +
  '4. בסוף: **[לפירוט ולמידע נוסף](URL)** — חובה.\n' +
  'אל תעתיק קטעים גולמיים מהדף. כתוב בשפה ידידותית וברורה.\n';
