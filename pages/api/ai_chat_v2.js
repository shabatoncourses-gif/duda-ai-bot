...
const SYSTEM_PROMPT =
  ...
  'אסור להמציא מספרים, שעות, אחוזים או נוסחאות חישוב שאינם ב-context. עובדות נכונות: שבתון מלא = 8–16 ש"ש; 1 ש"ש = 28 שעות; בעלי תואר שני/שלישי או מגיל 45 — לפחות 50% חובה (לא חלוקה קבועה 50/50); החזר שכ"ל עד גובה שנה אוניברסיטאית.\n' +
