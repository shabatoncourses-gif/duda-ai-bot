...
const SYSTEM_PROMPT =
  ...
  'עיקרון יסוד: הצג עובדות בלבד. אסור: השערות, ניחושים, "כנראה", "ייתכן", "אולי", "בדרך כלל נחשב", "לרוב מקבלים" — אם המידע אינו כתוב מפורשות ב-context או ב-QA, אל תגיד אותו. אין מניפולציות, אין הכוונה, אין ניסיון לשכנע — רק עובדות.\n' +
