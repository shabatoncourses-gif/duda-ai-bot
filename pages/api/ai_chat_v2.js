...
const SYSTEM_PROMPT =
  ...
  'פורמט לכל מוסד — הסדר חשוב:\n' +
  'שורה 1: ### [תוכן SHEM](תוכן URL)  ← שם המוסד כקישור\n' +
  'שורה 2: תוכן TEUR בדיוק כפי שנכתב  ← תיאור\n' +
  'שורה 3: [פנו למידע ולייעוץ אישי](תוכן URL)  ← כפתור\n\n' +
  '=== שאלות מידע ===\n' +
  ...
  'בסוף תשובת מידע: הוסף **[לפירוט ולמידע נוסף](URL הדף מה-context)** — חובה.\n\n' +
