...
const SYSTEM_PROMPT =
  ...
  '⛔ כלל חובה/השלמה: כשגולש שואל אם קורס מוכר כחובה או רשות — תשובה קצרה ולא מחייבת בלבד. התבנית: "בתחום זה יש קורסים שמוכרים כחובה ויש שמוכרים כרשות. מומלץ לפנות ישירות למוסד [קישור קטגוריה מה-context] ולוודא מול קרן ההשתלמות." אסור: לנקוט עמדה על הקורס הספציפי, להסביר מה הופך קורס לחובה/רשות, להסביר פרמטרים (תפקיד/גיל/ותק), להמציא URL שאינו ב-context.\n' +
...
function detectInfoPages(question) {
  ...
  const pages = [
    ...
    { kw: ['חובות לימודים','שעות חובה','שעות השלמה','שעות רשות','לימודי חובה','לימודי השלמה','מוסדות מאושרים','נושאי השתלמות','ספורט בשבתון','שינוי תוכנית','אופק חדש','תואר שלישי','דוקטורט','גמול השתלמות','מסלול אישי','פרויקט אישי','ישיבה','לימודים בחו"ל','לימודים בחול','תוכנית לימודים','תוכנית הלימודים','תכנית הלימודים','להרכיב תוכנית','הרכבת תוכנית','בניית תוכנית','מה ללמוד','כמה שעות','תכנית לימודים','לימוד בשבתון','לימודי רשות','לימודי חובה ורשות','מוסדות ללמוד','מוכר לשבתון','הכרה במוסד','האם מוכר','מוסד מוכר','קורס מוכר','מוכרת לשבתון','תוכנית הלימודים אושרה','תכנית הלימודים אושרה','אישור תוכנית הלימודים','אישור תכנית הלימודים','אישור הקרן','התוכנית אושרה','התכנית אושרה','אושרה על ידי הקרן','פורטל עובדי הוראה'], url: 'https://www.shabaton.online/learning_programs_shabaton' },
    ...
    { kw: ['החזר שכר לימוד','החזר שכ"ל','החזר שכל','כמה מחזירים','החזר לימודים','כמה מקבלים חזרה','חזרה על שכר לימוד','כמה מקבלים חזרה על שכר לימוד','כמה מחזירים על שכר לימוד','כמה מקבלים על שכר לימוד','החזר על שכר לימוד','כמה מקבלים על לימודים'], url: 'https://www.shabaton.online/tuition_reimbursement' },
...
async function buildContext(message, history) {
  ...
  const ALWAYS_PRIORITY_QA_IDS = new Set(['institution_not_responding', 'intensive_seminars', 'cinema_city_entertainment_center', 'half_shabaton_work_less', 'unused_study_budget_1', 'short_online_completion_institutions', 'tuition_reimbursement_rate']);
